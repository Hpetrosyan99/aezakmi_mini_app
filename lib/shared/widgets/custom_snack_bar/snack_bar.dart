...
class CustomSnackBar extends StatefulWidget {
  const CustomSnackBar.success({
    ...
    this.textStyle = const TextStyle(fontWeight: FontWeight.w600, fontSize: 16, color: Colors.white),
    this.maxLines = 2,
...
const kDefaultBoxShadow = [BoxShadow(color: Colors.black26, offset: Offset(0, 8), spreadRadius: 1, blurRadius: 30)];
