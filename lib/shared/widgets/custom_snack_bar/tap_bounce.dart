...
class TapBounceContainer extends StatefulWidget {
  const TapBounceContainer({Key? key, required this.child, this.onTap}) : super(key: key);
...
class TapBounceContainerState extends State<TapBounceContainer> with SingleTickerProviderStateMixin {
  ...
  @override
  void initState() {
    _controller = AnimationController(vsync: this, duration: animationDuration, upperBound: 0.04)
      ..addListener(() {
        if (mounted) {
          setState(() {});
        }
