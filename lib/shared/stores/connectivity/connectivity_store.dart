...
abstract class _ConnectivityStore with Store {
  ...
  Future<void> _init() async {
    ...
    _connectivitySubscription = connectivity.onConnectivityChanged.listen(_addStatus);
  }
  ...
  bool _isConnectionType(ConnectivityResult result) {
    return [ConnectivityResult.wifi, ConnectivityResult.mobile, ConnectivityResult.ethernet].contains(result);
  }
}
