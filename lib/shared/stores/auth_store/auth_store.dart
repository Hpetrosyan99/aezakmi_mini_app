...
abstract class AuthStoreBase with Store {
  ...
  @action
  Future<void> getCurrentUser({bool updateUserLoaded = false}) async {
  ...
  Future<AuthResponseDto> socialLogin(String code, SocialProviderEnum provider) async {
    final res = switch (provider) {
      SocialProviderEnum.GOOGLE => await _authProvider.googleLogin(SocialLoginDto(code: code, lang: 'en-US')),
      SocialProviderEnum.APPLE => await _authProvider.appleLogin(SocialLoginDto(code: code, lang: 'en-US')),
    };
